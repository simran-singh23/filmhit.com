    ...
    min-h-screen p-6">
      ...
      <div className="mb-10 text-gray-300 space-y-4">
        ...
        <p>
          ...
          <Link to="/movie/1" className="text-red-500 ml-2 
          hover:underline">
            Explore Now
          </Link>
        </p>
        ...
        <p>
          ...
          <Link to="/movie/2" className="text-red-500 ml-2 
          hover:underline">
            View Joker
          </Link>
        </p>
        ...
        <p>
          ...
          <Link to="/movie/3" className="text-red-500 ml-2 
          hover:underline">
            Watch Batman
          </Link>
        </p>
        ...
        <p>
          ...
          <Link to="/movie/4" className="text-red-500 ml-2 
          hover:underline">
            See Spider-Man
          </Link>
        </p>
