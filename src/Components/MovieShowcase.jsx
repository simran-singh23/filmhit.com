    ...
    <div className="bg-black text-white py-16 px-6 md:px-14">
      ...
      <div className="text-center mb-14">
        ...
        <p className="text-gray-400 max-w-2xl mx-auto">
          Watch trending movies, latest web series and blockbuster shows
          anytime anywhere.
        </p>
      </div>
        ...
        {movies.map((movie) => (
          ...
          >
            <div className="relative">
              ...
              <button className="absolute bottom-4 right-4 bg-white text-black p-4 rounded-full hover:scale-110 duration-300">
                <FaPlay />
              </button>
            </div>
      ...
      <div className="mt-20 bg-zinc-900 rounded-3xl p-10 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-10">
          <div>
                ...
                <h3 className="text-2xl font-semibold mb-3">4K Streaming</h3>
          ...
          <div>
            <h3 className="text-2xl font-semibold mb-3">Watch Anywhere</h3>
